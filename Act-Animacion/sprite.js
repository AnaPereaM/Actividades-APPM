function sprite () {
    this.width = 24000; // ****el ancho todal de mi spritesheet***
    this.height = 281; // ***el alto de mi spritesheet ***
    this.x = 0;
    this.y = 0;
    ...
    var numberOfFrames = 48; //*** El numero de frames que tiene mi spritesheet***
  ...
  sprite.prototype.draw = function (context) {
    var dodoImage = new Image(); //***puedes cambiar el nombre de la variable ***
    dodoImage.src = "dodo.png"; // ***el nombre de tu imagen***
    update();
    context.save();
    context.translate(this.x, this.y);
    
    context.drawImage(dodoImage, 
